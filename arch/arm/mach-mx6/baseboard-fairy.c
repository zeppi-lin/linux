...
static __init int fairy_init_sgtl5000(void) {
        fairy_sgtl5000_dev_name[0] = '0' + edm_i2c[1];
	...
	i2c_register_board_info(edm_i2c[1], &fairy_sgtl5000_i2c_data, 1);
...
void __init fairy_init_tlv320aic3x() {
