...
static __init int fairy_init_sgtl5000(void) {
	int i2c_bus = 1; /* TODO: get this from the module. */
        ...
        fairy_sgtl5000_dev_name[0] = '0' + i2c_bus;
	...
	fairy_sgtl5000_consumer_vddio.dev_name = fairy_sgtl5000_dev_name;
        ...
        fairy_audio_device.dev.platform_data = (struct mxc_audio_platform_data *)edm_analog_audio_platform_data;
        platform_device_register(&fairy_audio_device);
        
	i2c_register_board_info(i2c_bus, &fairy_sgtl5000_i2c_data, 1);
...
void __init fairy_init_lightsensor(void) {
	...
	i2c_register_board_info(2, &fairy_isl29023_binfo, 1);
}
...
void __init fairy_init_compass(void) {
	...
	i2c_register_board_info(2, &fairy_mag3110_binfo, 1);
}
...
void __init fairy_init_gsensor(void) {
	i2c_register_board_info(2, &fairy_lis331dlh_binfo, 1);
}
#endif
...
void __init fairy_init_rtc() {
        i2c_register_board_info(2, &fairy_ds1337_binfo, 1);
}
