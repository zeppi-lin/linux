...
static void edm_cf_imx6_hdmi_dev_init(int ipu_id, int disp_id) {
...
static struct fsl_mxc_hdmi_platform_data edm_cf_imx6_hdmi_data = {
	.init = edm_cf_imx6_hdmi_dev_init,
};
...
static void edm_cf_imx6_init_display_hdmi(void) {
...
static void edm_cf_imx6_init_display_lvds(void) {
	edm_cf_imx6_mux_pads_init_lvds();
...
static struct ipuv3_fb_platform_data edm_cf_imx6_fb_pdata[] = {
	{ /*fb0*/
	.disp_dev = "ldb",
...
static __init void edm_cf_imx6_init_ipu(void) {
	...
	if (cpu_is_mx6q()) {
		...
		for (i = 0; i < 4 && i < ARRAY_SIZE(edm_cf_imx6_fb_pdata); i++)
...
static void edm_cf_imx6_init_display(void) {
	edm_cf_imx6_init_display_hdmi();
	edm_cf_imx6_init_display_lvds();
	edm_cf_imx6_init_display_lcdif();
}
...
static void edm_cf_imx6_init_lcd_backlight(void)
{
